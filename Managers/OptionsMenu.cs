...
public class OptionsMenu : MonoBehaviour {
    ...
    private void OnEnable() {
        // Display text
        delayedTextDisplay.DisplayText("Welcome to the options menu!", true);
    ...
    public void OnSliderButtonReleased(string name) {
        // Delayed text display
        delayedTextDisplay.DisplayText(name + " volume set!", true);
    }
    ...
    public void DefaultSettings() {
        ...
        // Delayed text display
        delayedTextDisplay.DisplayText("Options set to their default values!", true);
    }
    ...
    public void MuteAudioButton() {
        ...
        if (!AudioListener.pause) {
            delayedTextDisplay.DisplayText("Audio has been muted!", true);
            muteAudioButtonText.text = "Unmute Audio";
            
            // Save settings
            PlayerPrefs.SetInt("Mute Audio", 0);
        } else {
            delayedTextDisplay.DisplayText("Audio has been unmuted!", true);
            muteAudioButtonText.text = "Mute Audio";
