    ...
    void SetName(int yesOrNo = -1) {
        ...
        if (yesOrNo == 0) {
            ...
            HighScore newHighScore = new HighScore(
                ...
                GameManager.S.speedMenuCS.speedDropdowns[0].options[GameManager.S.speedMenuCS.speedDropdowns[0].value].text,
                GameManager.S.speedMenuCS.speedDropdowns[1].options[GameManager.S.speedMenuCS.speedDropdowns[1].value].text,
                GameManager.S.speedMenuCS.speedDropdowns[2].options[GameManager.S.speedMenuCS.speedDropdowns[2].value].text,
                GameManager.S.speedMenuCS.speedDropdowns[3].options[GameManager.S.speedMenuCS.speedDropdowns[3].value].text,
                GameManager.S.algorithmMenuCS.chanceDropdowns[0].options[GameManager.S.algorithmMenuCS.chanceDropdowns[0].value].text,
                GameManager.S.algorithmMenuCS.chanceDropdowns[1].options[GameManager.S.algorithmMenuCS.chanceDropdowns[1].value].text,
                GameManager.S.algorithmMenuCS.chanceDropdowns[4].options[GameManager.S.algorithmMenuCS.chanceDropdowns[4].value].text,
                GameManager.S.algorithmMenuCS.chanceDropdowns[2].options[GameManager.S.algorithmMenuCS.chanceDropdowns[2].value].text,
