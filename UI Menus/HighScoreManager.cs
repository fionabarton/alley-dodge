...
public class HighScoreManager : MonoBehaviour {
    ...
    public float GetDefaultEntryEndingMoveSpeed(int level) {
        return (6 + (1 * (level - 1)));
    }
    public float GetDefaultEntryEndingSpawnSpeed(int level) {
        return (20 +  (3 * (level - 1)));
    }
    ...
    public void SetHighScoresToDefaultValues(bool saveData = false) {
        ...
        for (int i = 0; i < highScores.Length; i++) {
            highScores[i] = new HighScore(names[i], highestScore, (int)((highestScore * 0.2f) + 1), highestObjects,
                GameManager.S.score.GetTime(highestTime), "1 January, 2025", "12:00", 3, "1.68 m / 5 ft 6.14 in", 0, 0, 0,
                "6", "1", "20", "3",
                GetDefaultEntryEndingMoveSpeed((int)((highestScore * 0.2f) + 1)).ToString(),
                GetDefaultEntryEndingSpawnSpeed((int)((highestScore * 0.2f) + 1)).ToString());
    ...
    public void BackToMainMenuButton() {
        ...
        // Stop particle systems from looping (if "main menu fun" toggle is off)
        if (!MainMenuFun.S.allToggle.isOn) {
...
public class HighScore {
    ...
    public string endingObjectSpeed;
    public string endingSpawnSpeed;
    ...
    public HighScore(string _name = "", int _score = 0, int _level = 1, int _objects = 0, string _runTime = "00:00:00:000",
        string _date = "1 January, 2025", string _time = "12:00", int _alleyCount = 3, string _playerHeight = "1.68 m / 5 ft 6.14 in", int _fallBelowFloorCount = 0, int _damageCount = 0, int _pauseCount = 0,
        ...
        string _endingObjectSpeed = "6", string _endingSpawnSpeed = "20",
        ...
        endingObjectSpeed = _endingObjectSpeed;
        endingSpawnSpeed = _endingSpawnSpeed;
